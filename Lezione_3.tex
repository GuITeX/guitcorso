...
\usepackage{rotating, longtable, color, eurosym}
% \usepackage{amscd}
% \usepackage{colortbl}
\usepackage{booktabs}
\usepackage[all]{xy}
...
\date{10 dicembre 2009} % qui ci va anche l'evento
...
\begin{frame}
  ...
  \bigskip
	\begin{block}{Attenzione!}
		Occorre caricare il pacchetto \Lsty{booktabs}
	\end{block}
  ...
  \frametitle{La didascalia della tabella}
	...
	\begin{LaTeXoutput}
	  \begin{center}
		\begin{table}
		\begin{tabular}{p{.3\textwidth}r}
		\multicolumn{2}{c}{Tabella 1: titolo}\\[1ex]\toprule %block non digerisce \caption
		\multicolumn{2}{c}{intestazione}\\\midrule
		bianco & 102,5 \\
		nero   & 15,4 \\\bottomrule
		\end{tabular}
